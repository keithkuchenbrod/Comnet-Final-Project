...
def createDatapkt(src, Ndest, Rdest, dest1, dest2, dest3, data):
	"""
	Type(1)|SEQ(1)|LEN(2)|NDEST(1)|RDEST(1)|DEST1(1)|DEST2(1)|DEST3(1)|DATA(1-1491)print(str(4).encode('utf-8'))
	Type = 3, 1B
	...
	header = struct.pack('BBHBBBBB'3, seq, pktlen, src, Ndest, Rdest, dest1, dest2, dest3)
